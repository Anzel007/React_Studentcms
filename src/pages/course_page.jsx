...
//                   <th className="border p-2"><div class="table-cell text-left ...">ID</div></th>
//                   <th className="border p-2">Course Name</th>
//                   <th className="border p-2">Course Description</th>
//                   {/* <th className="border p-2">Duration of Course</th> */}
...
//                     <td className="border p-2">{course.start_date}</td>
//                     <td>
